...
@WebServlet("/CheckAdmPwdServlet")
public class CheckModAdmPwdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public CheckModAdmPwdServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//跳转到修改密码页面
		response.sendRedirect("modifyAdminPwd.jsp");
	}
